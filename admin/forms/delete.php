...
<div id="container">
	...
	<div id="content">
		...
		<div id="text_content">
			...
			<br><hr><br>
			Are you sure you want to delete the form?<br><br>
			<a href="../process.php?table=forms&action=delete&id='.$id.'" class="button">DELETE</a><a href="index.php" class="button">BACK</a>
			</div>
		</div>';
				}
			}
