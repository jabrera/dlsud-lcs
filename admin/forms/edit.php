...
<div id="container">
	...
	<div id="content">
			...
			if($ok == 0) {
				...
				if(isset($_GET['id'])) {
					$id = $_GET['id'];
					$editPost = mysql_query("SELECT * FROM forms WHERE id = '$id' LIMIT 1");
					$n = 0;
		...
		<div id="text_content">
			...
			<br><hr><br>
			<form action="../process.php?table=forms&action=edit&id='.$id.'" method="post">
			<table width="100%" cellspacing="0px" cellpadding="8px">
				...
				<tr valign="top">
					<td>Message</td>
					<td><textarea class="i_text" name="message" placeholder="Message">'.$message.'</textarea></td>
				</tr>
				<tr>
					<td></td>
