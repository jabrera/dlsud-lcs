	...
	<div id="content">
		...
		<div id="text_content">
			...
			<table width="100%" cellspacing="0px" cellpadding="8px">
				...
				<tr>
					<td></td>
					<td><input type="submit" class="button" name="post" value="POST"><input type="submit" class="button" name="preview" value="PREVIEW"></td>
				</tr>
			</table>
			<input type="hidden" class="i_text" name="posted_by" value="'.$loggedfirstname.' '.$loggedlastname.'">
			</form>
			</div>
		</div>';
				} else {
		...
		<div id="text_content">
			...
			<table width="100%" cellspacing="0px" cellpadding="8px">
				<tr>
					<td>Title</td>
					<td><input type="text" class="i_text" name="title" placeholder="Title"></td>
				</tr>
				<tr valign="top">
					<td>Content</td>
					<td><textarea class="i_text" name="content" placeholder="Message"></textarea></td>
				</tr>
				<tr>
					<td></td>
					<td><input type="submit" name="post" class="button" value="POST"><input type="submit" class="button" name="preview" value="PREVIEW"></td>
				</tr>
			</table>
			<input type="hidden" class="i_text" name="posted_by" value="'.$loggedfirstname.' '.$loggedlastname.'">
			</form>
