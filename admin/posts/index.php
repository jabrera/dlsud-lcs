	...
	<div id="content">
		...
		<div id="text_content">
			...
			<table width="100%">
				<tr>
					<td></td>
					<td align="right"><a href="new.php" class="button">NEW POST</a><a href="../" class="button">BACK</a></td>
				</tr>
			</table>
			<br><hr><br>
			<table width="100%" class="menu" cellspacing="0px" cellpadding="8px">
				<tr>
					<th width="500px">Post Title</th>
					<th colspan="3">Actions</th>';
				$getPost = mysql_query("SELECT * FROM posts ORDER BY id DESC");
				$z = 0;
				...
				<tr>
					...
					<td><a href="http://www.dlsudlcs.webege.com/?view_post='.$id.'">View</a></td>
