...
<div id="container">
	...
	<div id="content">
		...
		if(isset($_GET['view'])) {
			$id_vp = $_GET['view'];
			$querypost = mysql_query("SELECT * FROM forms WHERE id = '$id_vp' LIMIT 1");
			$n = 0;
			...
			<div id="title_con">
				...
				<div id="detail">
				<a href="forms.php?view='.$row['id'].'">'.$row['date_added'].'</a>
				</div>
			</div>
			<div id="text_content">
				<div id="padding20">
			...
			$n = 0;
			$queryposts = mysql_query("SELECT * FROM forms ORDER BY id DESC LIMIT 5");
